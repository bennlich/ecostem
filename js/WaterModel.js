define(['js/FireSeverityModel', 'js/ErosionModel'], function(fireSeverityModel, erosionModel) {
    ...
    function WaterModel() {
        ...
        this.burnSeverityModel = fireSeverityModel;
    ...
    WaterModel.prototype = _.extend(clonePrototype(DataModel.prototype), {
        reset: function() {
            ...
            var erosionModel = this.erosionModel;
        ...
        start: function() {
            ...
            this.erosionModel.start();
        },

        stop: function() {
            /* call superclass */
            DataModel.prototype.stop.call(this);
            this.erosionModel.stop();
        },
        ...
        step: function() {
            ...
            for (var i = 0; i < this.xSize; ++i) {
                for (var j = 0; j < this.ySize; ++j) {
                    ...
                    var burnSeverityModel = this.burnSeverityModel,
                    ...
                    this.erosionModel.world[i][j].erosion = patch.siltDeposit;
    ...
    window.WaterPatchRenderer = function(model) {
