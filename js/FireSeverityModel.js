define(function() {
    ...
    var FireSeverityModel = window.FireSeverityModel = function() {
        DataModel.call(this);

        this.defaultValue = {
            severity: FireSeverityModel.severityTypes.NONE
        };
    }
    ...
    window.FirePatchRenderer = function(model) {
